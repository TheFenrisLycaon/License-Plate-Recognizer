...
class DoubleValue(google___protobuf___message___Message):
    ...
    def __init__(
        self, *, value: typing___Optional[builtin___float] = None,
    ) -> None: ...
    def ClearField(
...
class BoolValue(google___protobuf___message___Message):
    ...
    def __init__(self, *, value: typing___Optional[builtin___bool] = None,) -> None: ...
    def ClearField(
        self, field_name: typing_extensions___Literal["value", b"value"]
    ) -> None: ...
...
class BytesValue(google___protobuf___message___Message):
    ...
    def __init__(
        self, *, value: typing___Optional[builtin___bytes] = None,
    ) -> None: ...
    def ClearField(
        self, field_name: typing_extensions___Literal["value", b"value"]
    ) -> None: ...
